    ...
    <div class="contact-container">
        ...
        <div class="contact-info-side">
            ...
            <p class="contact-subtitle">
                Have a project in mind, want to discuss a technical collaboration, or have an opportunity? Feel free to reach out. I'm always open to new connections and interesting conversations.
            </p>
            ...
            <div class="contact-details">
                ...
                <div class="contact-item">
                    ...
                    <span> <b> Qassim, Saudi Arabia </b> </span>
                </div>
            </div>
        </div>
        ...
        <div class="contact-form-side">
            <form action="{{ route('contact.store.en') }}" method="POST" class="contact-form" id="contactForm">                @csrf <!-- مفتاح الأمان الضروري جداً -->
                ...
                <div class="form-group">
                    ...
                    <div class="tags-container" id="tagsContainer">
                        <button type="button" class="reason-tag" data-value="Job Opportunity">Job Opportunity</button>
                        <button type="button" class="reason-tag" data-value="Project Inquiry">Project Inquiry</button>
                        <button type="button" class="reason-tag" data-value="Technical Collaboration">Technical Collaboration</button>
                        <button type="button" class="reason-tag" data-value="Networking & Connect">Networking & Connect</button>
                    </div>
    ...
    tags.forEach(tag => {
        tag.addEventListener('click', function () {
            ...
            if (!document.getElementById('resetTag')) {
                ...
                resetBtn.innerText = 'Change selection';
