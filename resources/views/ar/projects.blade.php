...
@section('content')
    <section class="new-projects-section">
        <h2 class="new-projects-heading">مشاريعي</h2>
        <p class="new-projects-subtitle">عرض للأنظمة التقنية، تطبيقات الويب، والإنجازات الهندسية.</p>
        ...
        <div class="new-projects-grid">
            ...
            <article class="new-proj-card new-empty-card">
                ...
                <div class="new-proj-body">
                    <h3 class="new-proj-title" style="color: #9CA3AF;">مشروع قادم قيد التنفيذ</h3>
